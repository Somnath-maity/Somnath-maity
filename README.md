...
| Project | Description |
|---------|-------------|
| [**Image-OCR**](https://github.com/Somnath-maity/Image-OCR) | Local RAG system for image-based Q&A — OCR, vector embeddings, and Claude LLMs. Built with Node.js, Python, FastAPI, Qdrant, and Docker. |
| [**MultiAgent-Orchestrator**](https://github.com/Somnath-maity/Multi-Agent-Orchestrator) | Gen AI multi-agent system with DAG-based planning, schema validation, retries, caching, and response re-ranking via Portkey. |
| [**HealthCare-Microservices**](https://github.com/Somnath-maity/HealthCare-Microservices) | Containerised microservices backend simulating deployment pipelines, production failures, and QA testing with Terraform, REST Assured & Docker. |

---

### Methodologies

`Agile / Scrum` &bull; `Responsive Design` &bull; `Component Architecture` &bull; `Performance Optimization` &bull; `Microservices` &bull; `Automation`
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=Somnath-maity&style=flat-square&color=38bdf8" />
</p>
